<div class="col m2">
    <ul class="collection side-nav">
        ...
        <li class="collection-item"><a href="{{ route('exp.create') }}"><i class="material-icons">add</i>নতুন ব্যয়</a></li>
        <li class="collection-item"><a href="{{ route('exp.index') }}"><i class="material-icons">money_off</i> ব্যয় সমূহ</a></li>
